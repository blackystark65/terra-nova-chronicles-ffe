...
// Sons via Web Speech API (synthèse vocale) — fallback fiable sans CORS
// Les vrais sons sont joués via speechSynthesis pour décrire l'animal
// Pour les oiseaux : sons freesound hébergés sur CDN public sans CORS
const CARTES = [
  // OISEAUX
  ...
  { id: 'pic_epeiche', nom: 'Pic épeiche', nom_en: 'Great spotted woodpecker', categorie: 'Oiseau', emoji: '🐦', couleur: 'from-red-600 to-rose-800',
    ...
    description: 'Oiseau grimpeur noir et blanc. Tambour sur les arbres pour communiquer.', points: 15 },
  ...
  { id: 'chevreuil', nom: 'Chevreuil', nom_en: 'Roe deer', categorie: 'Mammifère', emoji: '🦌', couleur: 'from-amber-600 to-orange-800',
    ...
    son_desc: 'Roe deer sharp barking alarm call, bark bark, short loud bark in forest',
  ...
  { id: 'herisson', nom: 'Hérisson', nom_en: 'Hedgehog', categorie: 'Mammifère', emoji: '🦔', couleur: 'from-yellow-700 to-amber-900',
    ...
    son_desc: 'Hedgehog snuffling and snorting at night, grunt grunt, shuffling in leaves',
  ...
  { id: 'grenouille', nom: 'Grenouille verte', nom_en: 'Green frog', categorie: 'Batracien', emoji: '🐸', couleur: 'from-green-500 to-emerald-700',
    ...
    son_desc: 'Frog croaking loudly, ribbit ribbit, chorus of frogs in pond',
    description: 'Amphibien des mares et étangs. Croassement typique des zones humides.', points: 10 },
  { id: 'salamandre', nom: 'Salamandre tachetée', nom_en: 'Fire salamander', categorie: 'Batracien', emoji: '🦎', couleur: 'from-yellow-500 to-black',
  ...
  { id: 'abeille', nom: 'Abeille mellifère', nom_en: 'Honeybee', categorie: 'Insecte', emoji: '🐝', couleur: 'from-yellow-400 to-amber-600',
    ...
    son_desc: 'Honeybee buzzing, high pitched buzz, busy bee humming in flowers',
  ...
  { id: 'bourdon', nom: 'Bourdon des prés', nom_en: 'Bumblebee', categorie: 'Insecte', emoji: '🐝', couleur: 'from-yellow-500 to-orange-600',
    ...
    son_desc: 'Bumblebee low deep buzzing, loud rumble buzz, bumble rumble in flower',
  ...
  { id: 'sureau', nom: 'Sureau noir', nom_en: 'Elderberry', categorie: 'Fleur', emoji: '🌸', couleur: 'from-purple-600 to-indigo-800',
  ...
  { id: 'froment', nom: 'Froment sauvage', nom_en: 'Wild wheat', categorie: 'Céréale', emoji: '🌾', couleur: 'from-yellow-600 to-amber-800',
  ...
  { id: 'seigle', nom: 'Seigle des prés', nom_en: 'Rye', categorie: 'Céréale', emoji: '🌾', couleur: 'from-amber-500 to-yellow-700',
