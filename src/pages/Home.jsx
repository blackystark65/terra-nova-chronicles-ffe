        ...
        <section className="flex-1 flex items-center justify-center px-4 py-20">
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              ...
              <motion.p
                className="text-2xl md:text-3xl font-bold text-emerald-400/80 mb-6"
            ...
            >
              ...
              <div className="relative px-8 py-6 rounded-3xl bg-white/5 backdrop-blur-xl border border-emerald-400/20">
                <p className="text-lg md:text-xl text-emerald-200/90 leading-relaxed">
                  Rejoins les <strong className="text-emerald-300">Éco-Sentinelles</strong> et explore les biomes de la Terre. 
                  Découvre la biodiversité, comprends les crises climatiques et agis pour protéger notre planète. 
                  Chaque mission compte. Chaque découverte change le monde.
                </p>
              </div>
            </motion.div>
